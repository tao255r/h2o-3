...
\item {\texttt{r2\_stopping}}: \\\texttt{r2\stopping} is no longer supported and will be ignored if set. Please use \\\texttt{stopping\rounds}, \\\texttt{stopping\_metric} and \\\texttt{stopping\tolerance} instead.
